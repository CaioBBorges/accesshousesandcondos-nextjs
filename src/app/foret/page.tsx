      ...
      <main>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
              <Image src="/uploads/2024/09/foret-why-foret-1024x1024.jpeg" alt="Why Foret" width={1024} height={1024} className="w-full h-auto object-cover rounded-xl shadow-lg" />
            </motion.div>
          </div>
        </section>
        ...
        <section className={`py-16 ${styles.wpBlockGallery}`}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Image src="/uploads/2024/09/foret-gallery-1-1024x604.jpeg" alt="Gallery 1" width={1024} height={604} className="w-full h-auto object-cover rounded-lg"/>
                    <Image src="/uploads/2024/09/foret-gallery-2-1024x576.jpeg" alt="Gallery 2" width={1024} height={576} className="w-full h-auto object-cover rounded-lg"/>
                    <Image src="/uploads/2024/09/foret-gallery-3-1024x531.jpeg" alt="Gallery 3" width={1024} height={531} className="w-full h-auto object-cover rounded-lg"/>
                    <Image src="/uploads/2024/09/foret-gallery-4-1024x682.jpeg" alt="Gallery 4" width={1024} height={682} className="w-full h-auto object-cover rounded-lg"/>
                </div>
            </div>
        </section>
        ...
        <section className="py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <Image src="/uploads/2024/09/foret-connectivity-1024x514.jpeg" alt="Connectivity" width={1024} height={514} className="w-full h-auto object-cover rounded-xl shadow-lg" />
            </div>
        </section>
